...
public class IncaricoResponseDTO {
    ...
    public IncaricoResponseDTO() {
    }

    public IncaricoResponseDTO(Long id, String numero_incarico, String tipo, Long id_assicurazione, Long id_liquidatore, Long idSoggetto, Long id_avvocato, int n_sinistro, Long id_dottore, LocalDateTime data_sinistro, LocalDateTime data_incarico, String note) {
        this.id = id;
    ...
    public void setNumeroIncarico(String numero_incarico) {
        this.numero_incarico = numero_incarico;
    }
